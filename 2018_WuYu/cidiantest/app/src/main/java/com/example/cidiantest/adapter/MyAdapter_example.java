package com.example.cidiantest.adapter;
...
public class MyAdapter_example extends ArrayAdapter<Item> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final MediaPlayer mMediaPlayer = MediaPlayer.create(getContext(),
                Uri.parse("android.resource://com.example.cidiantest/raw/"+word));

        //声明例子音频播放器
        final MediaPlayer examplePlayer = MediaPlayer.create(getContext(),
                Uri.parse("android.resource://com.example.cidiantest/raw/"+word+"_exp"));
        ...
        //给文本框等等赋值
        Button imageButton = v.findViewById(R.id._sound);  //点击播放单词音效
        final Button exampleSound = v.findViewById(R.id._exampleSound);  //点击播放音效
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(mMediaPlayer!=null){
                    ...
                    //Toast.makeText(getContext(),"暂无该单词音频资源",Toast.LENGTH_SHORT).show();
                    //从网络中播放对应单词读音
                    newMedia.start();
                }
            }
